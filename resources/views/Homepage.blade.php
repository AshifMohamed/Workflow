...
<div class="wrapper" style="height: auto; min-height: 100%;">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="file:///C:/Users/Ameer%20Shahib/Desktop/AdminLTE-2.4.1/index2.html" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><b>IT</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>IT </b>Department</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="AdminLTE%202%20%20%20Dashboard_files/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Sales Department
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="AdminLTE%202%20%20%20Dashboard_files/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Reviewers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="AdminLTE%202%20%20%20Dashboard_files/user2-160x160.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs">IT DEPARTMENT</span>
                        </a>
        ...
        <section class="sidebar" style="height: auto;">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="AdminLTE%202%20%20%20Dashboard_files/user2-160x160.jpg" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu tree" data-widget="tree">
                ...
                <li>
                    <a href="file:///C:/Users/Ameer%20Shahib/Desktop/TELEDA/EmpReq.php">
                        <i class="fa fa-anchor"></i> <span><b>User Access Request Form</b></span>
                ...
                <li>
                    <a href="file:///C:/Users/Ameer%20Shahib/Desktop/TELEDA/EmpReq.php">
                        <i class="fa fa-anchor"></i> <span><b>Sample Form</b></span>
                        <span class="pull-right-container">
            </span>
                    </a>
                </li>
                ...
                <li>
                    <a href="file:///C:/Users/Ameer%20Shahib/Desktop/TELEDA/EmpReq.php">
                        <i class="fa fa-anchor"></i> <span><b>Sample Form 2</b></span>
                        <span class="pull-right-container">
            </span>
                    </a>
                </li>
                ...
                <ul class="control-sidebar-menu">
                    ...
                    <li>
                        <a href="javascript:void(0)">
                            <h4 class="control-sidebar-subheading">
                                Update Resume
                                <span class="label label-warning pull-right">95%</span>
                            </h4>
...
<!-- jQuery 3 -->
<script src="AdminLTE%202%20%20%20Dashboard_files/jquery_003.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="AdminLTE%202%20%20%20Dashboard_files/bootstrap.js"></script>
<!-- FastClick -->
<script src="AdminLTE%202%20%20%20Dashboard_files/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="AdminLTE%202%20%20%20Dashboard_files/adminlte.js"></script>
<!-- Sparkline -->
<script src="AdminLTE%202%20%20%20Dashboard_files/jquery.js"></script>
<!-- jvectormap  -->
<script src="AdminLTE%202%20%20%20Dashboard_files/jquery-jvectormap-1.js"></script>
<script src="AdminLTE%202%20%20%20Dashboard_files/jquery-jvectormap-world-mill-en.js"></script>
<!-- SlimScroll -->
<script src="AdminLTE%202%20%20%20Dashboard_files/jquery_002.js"></script>
<!-- ChartJS -->
<script src="AdminLTE%202%20%20%20Dashboard_files/Chart.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="AdminLTE%202%20%20%20Dashboard_files/dashboard2.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="AdminLTE%202%20%20%20Dashboard_files/demo.js"></script>
