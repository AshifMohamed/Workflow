...
@section('content')
 ...
 <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{ route('hr.index') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
    ...
    <tr>
        ...
        <td><span class="label label-danger">{{ $request->request_status}}</span></td> 
         ...
         <td><span class="label label-success">{{ $request->request_status}}</span></td> 
          @endif
        <td>
            @if( $request->ciso_request)
            <a href="{{ route('hr.show',$request->request_id) }}" class="btn btn-sm btn-success"  title="View" ><i class="glyphicon glyphicon-pencil"></i> View&nbsp&nbsp&nbsp&nbsp  </a>
            @else
            <a href="{{ route('hr.edit',$request->request_id) }}" class="btn btn-sm btn-primary"  title="Edit" ><i class="glyphicon glyphicon-pencil"></i> Process  </a>
            @endif
