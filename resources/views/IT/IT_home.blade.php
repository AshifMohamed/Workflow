...
<table id="SMS" class="table table-bordered table-hover " >
    ...
    <tr>
        ...
        <td>
            ...
            <a href="{{ route('it.show',$request->request_id) }}" class="btn btn-sm btn-success"  title="View" ><i class="glyphicon glyphicon-pencil"></i> View&nbsp&nbsp&nbsp&nbsp  </a>
            @else
            <a href="{{ route('it.edit',$request->request_id) }}" class="btn btn-sm btn-primary"  title="Edit" ><i class="glyphicon glyphicon-pencil"></i> Process  </a>
            @endif
