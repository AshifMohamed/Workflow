...
@section('content')
 ...
 <div class="row">
    ...
    <div class="form-group col-md-6">
        <label>CISO</label>
        <input class="form-control pull-right" name="ciso" id="ciso" type="text" disabled >
    </div>
    ...
    <div class="form-group col-md-6">
        ...
        <input class="form-control pull-right" name="display_name" id="display_name" type="text" >
    </div>
    <div class="form-group col-md-6">
        <label>User Logon ID</label>
        <input class="form-control pull-right" name="logon_id" id="logon_id" type="text" >
    </div>
