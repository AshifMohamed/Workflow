    ...
    <tr>
        ...
        <td><span class="label label-warning">{{ $request->request_status}}</span></td> 
         ...
         <td><span class="label label-success">{{ $request->request_status}}</span></td>  
          @endif
        <td>
            @if( $request->it_request)
            <a href="{{ route('ciso.show',$request->request_id) }}" class="btn btn-sm btn-success"  title="View" ><i class="glyphicon glyphicon-pencil"></i> View&nbsp&nbsp&nbsp&nbsp  </a>
            @else
            <a href="{{ route('ciso.edit',$request->request_id) }}" class="btn btn-sm btn-primary"  title="Edit" ><i class="glyphicon glyphicon-pencil"></i> Process  </a>
            @endif
